...
const initialTasks: Task[] = [
  {
    ...
    description: "Initialize monorepo with Express, React, and shared packages.",
    status: "completed",
  ...
  },
  {
    ...
    description: "Create JWT-based auth with password hashing and cookies.",
    status: "pending",
  ...
  },
  {
    ...
    description: "Create reusable React components with TailwindCSS and shadcn/ui.",
    status: "pending",
    estimatedEffort: "medium",
  },
  {
    ...
    description: "Add a comprehensive README with setup and deployment instructions.",
    status: "pending",
